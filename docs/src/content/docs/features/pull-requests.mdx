...
Five tabs across the top: **Conversation**, **Files**, **Commits**,
**Checks**, **References**. Switch with `← / →`. The right edge of the
tab bar shows state-action shortcuts (`Ctrl+X close`, `Ctrl+D to draft`,
etc.) that follow the current PR state.
