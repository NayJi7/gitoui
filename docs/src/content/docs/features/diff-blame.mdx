...
![Side-by-side diff, OLD left (red deletions) / NEW right (green additions), syntax-highlighted via syntect](https://raw.githubusercontent.com/NayJi7/gitoui/master/assets/readme/diff-side-by-side.png)
...
![Blame view, left gutter with hash + author + date, focused blame block highlighted, syntax-highlighted source](https://raw.githubusercontent.com/NayJi7/gitoui/master/assets/readme/blame-view.png)
