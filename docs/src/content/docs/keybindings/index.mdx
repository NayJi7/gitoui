...
[Custom keybindings](custom/) for the full action list per
scope.

| Scope path                         | View                                       |
|------------------------------------|--------------------------------------------|
| `list`                             | Commit list (the home screen).             |
| `detail`                           | Commit detail, currently hosts `revert` (`v`), which would otherwise collide with `clean_untracked` in the uncommitted view. |
...
![In-app Help page, sectioned grid of shortcuts per scope, keys drawn from the live keybind map](https://raw.githubusercontent.com/NayJi7/gitoui/master/assets/readme/home-help.png)
