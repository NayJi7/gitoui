...
| `initial_load_count`| usize / `500` (clamped `10..99_999`)     | Number of commits loaded on startup. Editable from the Configuration view (`p`) as a text input, takes effect on the **next launch**. |
