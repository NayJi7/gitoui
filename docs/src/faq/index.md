...
Gitoui displays graphs using specific terminal graphics protocols (such as Kitty and iTerm2 inline images).

**If your terminal emulator doesn't support one of these protocols, Gitoui will not work — there is no fallback or workaround.**
...
Compared to other git TUI clients, Gitoui offers the following advantages:

- High-quality graph visualization using terminal graphics protocols
- Simple and clean interface

On the other hand, Gitoui may not be for you if:
...
It is pronounced as the German word Gitoui (**/ˈzeːriə/**), roughly like **"ZAY-ree-eh"**, not like the English "series".
