...
fn dracula() -> ThemeDefinition {
    ThemeDefinition {
        ...
        color_theme: ColorTheme {
            ...
            list_head_fg:                   rgb(0x50, 0xfa, 0x7b),
            list_commit_message_fg:         rgb(0xf8, 0xf8, 0xf2),
            list_name_fg:                   rgb(0x8b, 0xe9, 0xfd),
            ...
            detail_name_fg:                 rgb(0x8b, 0xe9, 0xfd),
...
fn nord() -> ThemeDefinition {
    ThemeDefinition {
        ...
        color_theme: ColorTheme {
            ...
            list_head_fg:                   rgb(0x5e, 0x81, 0xac),
            list_commit_message_fg:         rgb(0xd8, 0xde, 0xe9),
            list_name_fg:                   rgb(0x88, 0xc0, 0xd0),
            ...
            detail_name_fg:                 rgb(0x88, 0xc0, 0xd0),
            detail_date_fg:                 rgb(0xb4, 0x8e, 0xad),
            detail_email_fg:                rgb(0x81, 0xa1, 0xc1),
